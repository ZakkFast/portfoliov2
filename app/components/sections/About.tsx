  ...
  return (
    <Container className="pt-28 lg:pt-32" id="about">
      ...
      <div className="mx-auto max-w-5xl">
        <h2 className="pb-8 text-center text-3xl text-gray-950 lg:pb-10 lg:text-4xl dark:text-white">
          I like understanding how things actually work
          <span className="text-4xl text-cyan-400 lg:text-5xl">.</span>
        </h2>

        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.25fr)_minmax(340px,0.75fr)] lg:gap-16">
